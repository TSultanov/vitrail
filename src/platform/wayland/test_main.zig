// Wayland test entry point. Default: runs the cross-platform scenarios with
...
// wl_keyboard / wl_pointer paths work.
...
pub fn main() !void {
    ...
    const presenter = try MainPresenter.init(.{}, allocator, false);
    ...
    const driver = try TestDriver.create(allocator, presenter, "/tmp/vitrail-wayland-tests");
