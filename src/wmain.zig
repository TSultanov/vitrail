...
pub export fn main() c_int {
    _ = w.FreeConsole(); //TODO: zig currently has issues with wWinMain and using windows subsystem directly when linking against libc, so we are closing console manually here
